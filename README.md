...
[Visual Studio Community Edition](https://visualstudio.microsoft.com/vs/) was the primary integrated development environment used when developing this website.  Using Visual Studio Community 2019 is recommended - but not required.  The subsequent instructions will take you through the steps required to run the server locally on your computer.

### Windows
_Please note that the terminology "Windows Subsystem for Linux (WSL)" and "Bash" may be used interchangeably in the instructions below._
